...
/*
class CreateYourProfile extends StatefulWidget {
  static const String routeName = '/createyourprofile';
  const CreateYourProfile({Key? key}) : super(key: key);

  @override
  State<CreateYourProfile> createState() => _CreateYourProfile();
}

class _CreateYourProfile extends State<CreateYourProfile> {
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Image.asset("image/Open Doodles Solo.png",  height: 200, width: 200,
                          fit: BoxFit.contain,),
                      ),
                      ...
                      Align(
                        ...
                        child:  Text("Create your profile", style: TextStyle(fontSize: 20, color: Color.fromARGB(
                            255, 21, 43, 75),
                      ...
                      Container(
                        ...
                        color: Colors.white,
                        child: Form(
                          key: _createyourprofile,

                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              CustomTextfiel(controller: _nameController  , hintext: 'Name'),
                              SizedBox(height: 10,),
                              CustomTextfiel(controller:  _matricController, hintext: 'Surname'),
                              SizedBox(height: 10,),
                              CustomTextfiel(controller:  _facultyController , hintext: 'Age'),
                              SizedBox(height: 20,),
                              ...
                              ElevatedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if(_createyourprofile.currentState!.validate()){
                                    createprofile();
                                  }
